...
function wsl_component_buddypress_setup_profile_mapping()
{
	...
	$ha_profile_fields = array(
		...
		array( 'field' => 'studentStatus'         , 'label' => _wsl__( "Student status"                      , 'wordpress-social-login'), 'description' => _wsl__( "User's student status"                                                                                                         , 'wordpress-social-login') ),
		array( 'field' => 'staffStatus'         , 'label' => _wsl__( "Staff status"                      , 'wordpress-social-login'), 'description' => _wsl__( "User's staff status"                                                                                                         , 'wordpress-social-login') ),
	); 
?>
<div class="stuffbox">
	<h3>
